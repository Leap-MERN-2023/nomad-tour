    ...
    <div className="bg-white rounded-xl p-6 lg:w-[900px]">
      ...
      <div className="p-3 flex flex-col gap-1">
        <div className=" gap-1 lg:flex lg:justify-between">
          ...
          <input className="rounded-xl p-2 border-[1px]  bg-white w-full lg:h-10 lg:w-[250px]" />
          </div>
          <div>
        ...
        <div className="flex justify-between ">
          <input className="w-[120px] p-2 rounded-xl bg-white  border-[1px] lg:h-10 lg:w-[30%] "/>
          <input className="w-42 p-2 rounded-xl bg-white  border-[1px] lg:h-10 lg:w-[65%] w-32 "/>
        </div>
        <div className="lg:flex lg:justify-between">
        <div className="">
          <p className="text-black">Citizen</p>
          <input className="rounded-xl  border-[1px] p-2  bg-white w-full lg:h-10 lg:w-[400px]" />
        </div>
        <div>
